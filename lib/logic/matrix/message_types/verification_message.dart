...
class _MatrixVerifictionMessageRenderer extends StatefulWidget {
  ...
  @override
  State<_MatrixVerifictionMessageRenderer> createState() =>
      __MatrixVerifictionMessageRendererState();
}

class __MatrixVerifictionMessageRendererState
    extends State<_MatrixVerifictionMessageRenderer> {
  @override
  void initState() {
    var request = AngerApp.matrix.client.encryption?.keyVerificationManager
        .getRequest(widget.event.eventId);
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("Verifizierungs-Anfrage",
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                        ...
                        onPressed: () {
                          AngerApp.matrix
                              .showKeyVerificationDialog(request)
                              .then((value) {
                            setState(() {});
                          });
                        },
